      ...
      <div class="news-container">
        <div class="news-item">
          ...
          <div class="news-content">
            ...
            <p class="news-summary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        ...
        <div class="news-item">
          ...
          <div class="news-content">
            ...
            <p class="news-summary">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            <a href="#" class="read-more-link" style="color: white;">Read More</a>
          </div>
        </div>
        <div class="news-item">
          ...
          <div class="news-content">
            ...
            <p class="news-summary">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
            <a href="#" class="read-more-link" style="color: white;">Read More</a>
          </div>
        </div>
      </div>
