...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" href="img/avatar.png" type="image">
  ...
  <div class="session">
    <div class="left">
      <svg enable-background="new 0 0 300 302.5" version="1.1" viewBox="0 0 300 302.5" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
        <style type="text/css">
          .st01{fill:#fff;}
            ...
            <form action="{{ route('register') }}" class="log-in" autocomplete="off" method="POST">
                @csrf
              <h4>Register</span></h4>
      ...
      <div class="floating-label">
        <input placeholder="Konfirmasi Password" type="password" name="password_confirmation" id="password" autocomplete="off">
      ...
      <a href="{{ route('login') }}" class="discrete">Login</a>
    </form>
  </div>
</body>
</html>
